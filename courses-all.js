...
script.onload = function() {
    ...
    $(document).ready(function() {
        ...
        function adjustContainerHeight(container) {
            ...
            var cardHeight = cards[0]?.offsetHeight || 200; // Estimated height of each card in pixels, adjust as needed
            var gap = 16; // Gap between cards in pixels, adjust as needed
        ...
        var clubStyles = `
            ...
            .club-content {
                padding: 16px; /* Add padding for the content (name and countryName) */
            }
