...
script.onload = function() {
    $(document).ready(function() {
        ...
        function createFilterChips(data) {
            ...
            // Adjust the height of the filter bar dynamically
            adjustFilterBarHeight();
        ...
        // New function to adjust the height of the filter bar dynamically
        function adjustFilterBarHeight() {
            var filterBar = document.getElementById('filter-bar');
            filterBar.style.height = 'auto';
            var height = filterBar.scrollHeight;
            filterBar.style.height = height + 'px';
        }
        ...
        // Adjust filter bar height on window resize
        $(window).resize(adjustFilterBarHeight);
    });
};
