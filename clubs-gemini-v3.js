...
script.onload = function() {
    $(document).ready(function() {
        ...
        function fetchClubs() {
            $.ajax({
                ...
                success: function(data) {
                    ...
                    updateFilterChips(); // Update chip text after creation
                },
        ...
        function updateFilterChips() {
            ...
            // Update filter chip text after data is fetched
            $('.filter-chips').find('.filter-chip').each(function() {
        ...
        addCSSStyles();
        // Remove the hardcoded filter chip creation
        // createAndAppendFilterBar();
        fetchClubs();

        // Event delegation for filter chips: attach to the filter-chips container
